...
#include <memory>
#include "../task_1/specialcharacter.h"
...
struct qt_meta_stringdata_SpecialCharacter_t {
    const uint offsetsAndSize[2];
    char stringdata0[17];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_SpecialCharacter_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_SpecialCharacter_t qt_meta_stringdata_SpecialCharacter = {
    {
QT_MOC_LITERAL(0, 16) // "SpecialCharacter"
...
const QMetaObject SpecialCharacter::staticMetaObject = { {
    ...
    qt_meta_stringdata_SpecialCharacter.offsetsAndSize,
    qt_meta_data_SpecialCharacter,
    qt_static_metacall,
    nullptr,
    nullptr,
    nullptr
...
void *SpecialCharacter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SpecialCharacter.stringdata0))
